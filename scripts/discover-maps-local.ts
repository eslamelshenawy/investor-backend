/**
 * Local discovery script for "المساحة والخرائط" category
 * Uses local Chrome instead of Browserless
 *
 * Usage: npx ts-node scripts/discover-maps-local.ts
 */
...
async function main() {
  console.log('═'.repeat(60));
  console.log(`🚀 Maps Category Discovery (Local Chrome)
📍 Category: ${CATEGORY_NAME}`);
  console.log('═'.repeat(60));
